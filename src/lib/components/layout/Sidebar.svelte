<script lang="ts">
	...
	chatId.subscribe((value) => console.log('chatId changed to:', value));
	page.subscribe((value) => console.log('page changed to:', value));
	...
	>
		...
		<div class="px-2.5 flex justify-center text-gray-800 dark:text-gray-200">
			...
			>
				...
				<div class="flex self-center">
					<div class=" self-center font-medium text-sm font-primary">{$i18n.t('dashbaord')}</div>
				</div>
			</a>
		</div>
		...
		<div class="px-2.5 flex justify-center text-gray-800 dark:text-gray-200">
			...
			>
				...
				<div class="flex self-center">
					<div class=" self-center font-medium text-sm font-primary">{$i18n.t('Editor')}</div>
				</div>
			</a>
		</div>
		...
		<div class="px-2.5 flex justify-center text-gray-800 dark:text-gray-200">
			...
			>
				...
				<div class="flex self-center">
					<div class=" self-center font-medium text-sm font-primary">{$i18n.t('canvas')}</div>
				</div>
			</a>
		</div>
		...
		<div class="px-2.5 flex justify-center text-gray-800 dark:text-gray-200">
			<a
				...
				href="/clock/"
					on:click={() => {
						...
						console.log("$page.url.pathname")
						console.log($page.url.pathname);
						console.log("Now switching to /clock")
			...
			>
				...
				<div class="flex self-center">
					<div class=" self-center font-medium text-sm font-primary">{$i18n.t('timer')}</div>
				</div>
			</a>
		</div>
